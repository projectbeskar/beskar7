...
kubectl logs -n capb7-system deployment/beskar7-controller-manager -f
...
# Restart Beskar7
kubectl rollout restart deployment/beskar7-controller-manager -n capb7-system
```
...
kubectl logs -n capb7-system deployment/beskar7-controller-manager | grep inspection
...
# Check controller logs
kubectl logs -n capb7-system deployment/beskar7-controller-manager | grep -i power
```
...
kubectl edit deployment beskar7-controller-manager -n capb7-system
...
```bash
# Check controller is running
kubectl get deployment -n capb7-system beskar7-controller-manager
# Should show: READY 1/1

# Check controller logs for errors
kubectl logs -n capb7-system deployment/beskar7-controller-manager --tail=100 | grep -i error

# Check webhook is healthy
kubectl get endpoints -n capb7-system beskar7-webhook-service
```
...
# Set resource limits
kubectl edit deployment -n capb7-system beskar7-controller-manager
...
```bash
# Controller logs
kubectl logs -n capb7-system deployment/beskar7-controller-manager > controller-logs.txt
