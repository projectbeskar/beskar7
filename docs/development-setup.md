...
The default `IMG` value in the Makefile is `ghcr.io/projectbeskar/beskar7/beskar7:v0.9.0`. Override it to push to your own registry.
...
```bash
make clusterctl-override VERSION=v0.9.0        # writes ~/.cluster-api/overrides/infrastructure-beskar7/v0.9.0/
clusterctl init --infrastructure beskar7:v0.9.0 # needs the provider in ~/.cluster-api/clusterctl.yaml, see Installation
```
